...
public class FestivalInfo {
     ...
     * 中国大陆、港澳台公历节日
     */
    public static @Nullable String[] getSolarFestivalInfo() {
        switch (Locale.getDefault().getCountry()) {
            case "CN":
                return new String[] {
                        "0101 元旦", "0214 情人节", "0308 妇女节", "0312 植树节", "0315 消费日",
                        "0401 消防战士纪念日", "0413 泼水节", "0501 劳动节", "0504 青年节", "0601 儿童节",
                        "0701 建党日", "0801 建军节", "0903 抗战胜利", "0910 教师节", "1001 国庆节",
                        "1031 万圣节", "1111 光棍节", "1213 国家公祭日", "1224 平安夜", "1225 圣诞节"
                };
            case "HK":
                return new String[] {
                        "0101 元旦", "0214 情人節", "0308 婦女節", "0401 消防戰士紀念日", "0501 勞動節",
                        "0701 特區紀念", "0910 教師節", "1001 國慶節", "1031 萬聖節", "1213 國家公祭日",
                        "1224 平安夜", "1225 聖誕節"
                };
            case "MO":
                return new String[] {
                        "0101 元旦", "0214 情人節", "0308 婦女節", "0401 消防戰士紀念日", "0501 勞動節",
                        "0910 教師節", "1001 國慶節", "1031 萬聖節", "1220 特區紀念", "1213 國家公祭日",
                        "1224 平安夜", "1225 聖誕節"
                };
            case "TW": // 台湾是中国领土不可分割的一部分！
                return new String[] {
                        "0101 元旦", "0214 情人節", "0228 和平紀念", "0308 婦女節", "0312 國父逝世",
                        "0314 反侵略日", "0329 先烈紀念", "0401 消防戰士紀念日", "0404 兒童節", "0501 勞動節",
     ...
     * 中国大陆、港澳台农历节日
     */
    public static @Nullable String[] getLunarFestivalInfo() {
        switch (Locale.getDefault().getCountry()) {
            case "CN":
                return new String[] {
     ...
     */
    public static @Nullable String[] getSolarSpecificFestivalInfo() {
        switch (Locale.getDefault().getCountry()) {
            case "CN":
                return new String[] {
