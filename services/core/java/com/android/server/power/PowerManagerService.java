...
public final class PowerManagerService extends SystemService
    ...
    public void systemReady(IAppOpsService appOps) {
        ...
        resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
                ...
                false, mSettingsObserver, UserHandle.USER_ALL);
        resolver.registerContentObserver(MoKeeSettings.Secure.getUriFor(
                MoKeeSettings.Secure.KEYBOARD_BRIGHTNESS),
                false, mSettingsObserver, UserHandle.USER_ALL);
        resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
    ...
    private void updateSettingsLocked() {
        ...
        mKeyboardBrightness = MoKeeSettings.Secure.getFloatForUser(resolver,
                MoKeeSettings.Secure.KEYBOARD_BRIGHTNESS, mKeyboardBrightnessSettingDefault,
                UserHandle.USER_CURRENT);
