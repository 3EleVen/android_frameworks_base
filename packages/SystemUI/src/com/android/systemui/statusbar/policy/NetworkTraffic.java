...
public class NetworkTraffic extends TextView {
    ...
    private void updateSettings() {
        ...
        mLocation = Settings.Secure.getIntForUser(resolver,
        ...
        mUnits = Settings.Secure.getIntForUser(resolver,
                Settings.Secure.NETWORK_TRAFFIC_UNITS, /* Bytes */ 1,
                UserHandle.USER_CURRENT);

        mRefreshInterval = Settings.Secure.getIntForUser(resolver,
                Settings.Secure.NETWORK_TRAFFIC_REFRESH_INTERVAL, 2, UserHandle.USER_CURRENT);
        mHideArrows = Settings.Secure.getIntForUser(resolver,
                Settings.Secure.NETWORK_TRAFFIC_HIDEARROW, 0, UserHandle.USER_CURRENT) == 1;
